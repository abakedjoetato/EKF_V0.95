...
public class LeaderboardCommand implements ICommand {
    ...
    private void displayDistanceLeaderboard(SlashCommandInteractionEvent event) {
        ...
        List<Player> distancePlayers = playerRepository.getTopPlayersByDistance(10);
        ...
        event.getHook().sendMessageEmbeds(
                EmbedUtils.createEmbed("Longest Kill Distance Leaderboard", 
    ...
    private void displayStreakLeaderboard(SlashCommandInteractionEvent event) {
        ...
        List<Player> streakPlayers = playerRepository.getTopPlayersByKillStreak(10);
    ...
    private void displayWeaponsLeaderboard(SlashCommandInteractionEvent event) {
        ...
        event.getHook().sendMessageEmbeds(
                EmbedUtils.createEmbed("Top Weapons Leaderboard", 
                                      description.toString(),
                                      EmbedUtils.EMERALD_GREEN,
                                      "attachment://WeaponStats.png")
        ).queue();
    ...
    private void displayDeathsLeaderboard(SlashCommandInteractionEvent event) {
        ...
        List<Player> deathPlayers = playerRepository.getTopPlayersByDeaths(10);

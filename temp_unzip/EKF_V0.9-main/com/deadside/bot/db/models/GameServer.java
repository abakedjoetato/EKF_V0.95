...
public class GameServer {
    ...
    /**
     * Update killfeed processing progress
     * 
     * @param file The last killfeed file that was processed
     * @param line The last line number in that file that was processed
     */
    ...
    /**
     * Update killfeed processing progress with a specific timestamp
     * 
     * @param file The last killfeed file that was processed 
     * @param line The last line number in that file that was processed
     * @param timestamp The timestamp to set (instead of current time)
     */
    public void updateKillfeedProgress(String file, long line, long timestamp) {
        this.lastProcessedKillfeedFile = file;
        this.lastProcessedKillfeedLine = line;
    ...
    /**
     * Update log processing progress
     * 
     * @param file The last log file that was processed
     * @param line The last line number in that file that was processed
     */
    ...
    /**
     * Update log processing progress with a specific timestamp
     * 
     * @param file The last log file that was processed
     * @param line The last line number in that file that was processed
     * @param timestamp The timestamp to set (instead of current time)
     */
    public void updateLogProgress(String file, long line, long timestamp) {
        this.lastProcessedLogFile = file;
        this.lastProcessedLogLine = line;
        this.lastProcessedTimestamp = timestamp;
    }
